...
export let overlayHandlerContent
 ...
 * @param {KeyboardEvent} e The keydown event.
 */
export function overlayKeyDismissableHandler(e) {
    if (e.key === 'Enter') {
        document.getElementById(overlayHandlerContent).getElementsByClassName('overlayKeybindEnter')[0].click()
 ...
 */
export function bindOverlayKeys(state, content, dismissable) {
...
export async function toggleServerSelection(toggleState) {
...
window.setOverlayContent = setOverlayContent
window.setOverlayHandler = setOverlayHandler
window.setMiddleButtonHandler = setMiddleButtonHandler
window.setDismissHandler = setDismissHandler
 ...
 */
export function setOverlayHandler(handler) {
    if (handler == null) {
 ...
 * @param {function} handler
 */
export function setMiddleButtonHandler(handler) {
    if (handler == null) {
...
export function setServerListingHandlers() {
...
export function setAccountListingHandlers() {
...
export function prepareAccountSelectionList() {
